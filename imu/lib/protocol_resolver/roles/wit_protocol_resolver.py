# coding:UTF-8
import time
from imu.lib.protocol_resolver.interface.i_protocol_resolver import IProtocolResolver
...
class WitProtocolResolver(IProtocolResolver):
    ...
    PackSize = 11        # Data Packet Size
    gyroRange = 2000.0   # Angular Velocity Range
    accRange = 16.0      # Acceleration Range
    angleRange = 180.0   # Angular Range
    TempFindValues=[]    # Read Data Returned from the Specified Register
